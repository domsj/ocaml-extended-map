...
module type S =
  sig
    ...
    sig
      type 'a m = 'a t
      type 'a t
      val first : 'a m -> 'a t option
      val last : 'a m -> 'a t option
      val get : 'a t -> key * 'a
      val next : 'a t -> 'a t option
      val prev : 'a t -> 'a t option
      val jump : ?dir:direction -> key -> 'a m -> 'a t option
    end
    module Cursor :
    sig
      type 'a m = 'a t
      type 'a t
      val with_cursor : 'a m -> ('a t -> 'c) -> 'c
      val is_valid : 'a t -> bool
      val first : 'a t -> bool
      val last : 'a t -> bool
      val jump : ?dir:direction -> key -> 'a t -> bool
      val next : 'a t -> bool
      val prev : 'a t -> bool
      val get : 'a t -> key * 'a
    end
